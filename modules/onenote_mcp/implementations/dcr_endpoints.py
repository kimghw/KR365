...
def add_dcr_endpoints(app):
    ...
    # OneNote DB Service for account management
    from ...dcr_oauth_module.onenote_db_service import OneNoteDBService
    onenote_db_service = OneNoteDBService()
    ...
    async def oauth_authorize(
        ...
        scope: str = "Notes.Read Notes.ReadWrite User.Read",
        state: str = None,
                ...
                try:
                    async with httpx.AsyncClient(timeout=30.0) as client:
                        ...
                        if response.status_code == 200:
                            ...
                            # Save account to OneNote database with tokens and fill NULL values
                            ...
                            delegated_permissions = " ".join(scopes) if scopes else "Notes.Read Notes.ReadWrite User.Read"

                            # Update account with complete information
                            onenote_db_service.execute_query("""
                            ...
                            logger.info(f"✅ Updated account in onenote.db with complete info: {user_email}")
    ...
    async def oauth_token(
        ...
        if grant_type == "authorization_code":
            ...
            # Update OneNote database with new tokens
            onenote_db_service.upsert_account(
                user_id=user_email,
            ...
            logger.info(f"✅ OneNote account updated with new tokens: {user_email}")
        ...
        # Refresh token grant
            ...
            # Update OneNote database with refreshed tokens
            onenote_db_service.upsert_account(
            ...
            logger.info(f"✅ OneNote account updated with refreshed tokens")
